...
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("dagon_industry:textures/gui/arc_furnace.png");

    public ArcFurnaceScreen(ArcFurnaceContainer screenContainer, PlayerInventory inv, ITextComponent titleIn)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int x, int y)
    {
        ...
        ArcFurnaceTileEntity te = (ArcFurnaceTileEntity) this.container.te;
        ...
        this.blit(matrixStack, this.guiLeft + 78, this.guiTop + 40, 176, 16, (int) (progress / Math.max(0.01, ArcFurnaceTileEntity.MAX_PROGRESS / 23d)), 16);
        ...
        {
            mc.getTextureManager().bindTexture(TEXTURE);
            this.blit(matrixStack, this.guiLeft + 17, this.guiTop + 32, 176, 32, 16, 16);
        }
