...
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("dagon_industry:textures/gui/carbon_generator.png");
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int x, int y)
    {
        ...
        CarbonGeneratorTileEntity te = (CarbonGeneratorTileEntity) this.container.te;
