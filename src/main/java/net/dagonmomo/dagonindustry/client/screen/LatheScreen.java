...
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("dagon_industry:textures/gui/lathe.png");
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int x, int y)
    {
        ...
        LatheTileEntity te = (LatheTileEntity) this.container.te;
        ...
        this.blit(matrixStack, this.guiLeft + 78, this.guiTop + 40, 176, 16, (int) (progress / Math.max(0.01, LatheTileEntity.MAX_PROGRESS / 23d)), 16);
