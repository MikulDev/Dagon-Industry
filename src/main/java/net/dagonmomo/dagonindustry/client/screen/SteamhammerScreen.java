...
public class SteamhammerScreen extends ContainerScreen<SteamhammerContainer>
{
    private static final ResourceLocation TEXTURE = new ResourceLocation("dagon_industry:textures/gui/steamhammer.png");

    public SteamhammerScreen(SteamhammerContainer screenContainer, PlayerInventory inv, ITextComponent titleIn)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int x, int y)
    {
        ...
        SteamhammerTileEntity te = (SteamhammerTileEntity) this.container.te;
        ...
        this.blit(matrixStack, this.guiLeft + 78, this.guiTop + 40, 176, 16, (int) (progress / Math.max(0.01, SteamhammerTileEntity.MAX_PROGRESS / 23d)), 16);
