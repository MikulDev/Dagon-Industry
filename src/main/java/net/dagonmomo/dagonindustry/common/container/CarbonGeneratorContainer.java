...
import net.dagonmomo.dagonindustry.common.te.CarbonGeneratorTileEntity;
...
public class CarbonGeneratorContainer extends AbstractMachineContainer
{
    public CarbonGeneratorContainer(final int windowId, final PlayerInventory playerInv, final CarbonGeneratorTileEntity te)
    {
        super(ContainerInit.CARBON_GENERATOR_CONTAINER.get(), windowId, te);
