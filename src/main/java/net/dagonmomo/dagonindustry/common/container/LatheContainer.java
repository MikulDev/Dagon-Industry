...
public class LatheContainer extends AbstractMachineContainer
{

    public LatheContainer(final int windowId, final PlayerInventory playerInv, final LatheTileEntity te)
    {
        super(ContainerInit.LATHE_CONTAINER.get(), windowId, te);
    ...
    public LatheContainer(final int windowId, final PlayerInventory playerInv, final PacketBuffer data)
    {
        this(windowId, playerInv, getTileEntity(playerInv, data));
    }

    private static LatheTileEntity getTileEntity(final PlayerInventory playerInv, final PacketBuffer data)
    {
        Objects.requireNonNull(playerInv, "Player inventory cannot be null");
        Objects.requireNonNull(data, "PacketBuffer cannot be null");
        final TileEntity te = playerInv.player.world.getTileEntity(data.readBlockPos());
        if (te instanceof LatheTileEntity)
        {
            return (LatheTileEntity) te;
        }
